...
We created a **Todo List App** that supports **CRUD operations**:  
- **ADD** tasks to the application  
- **READ** tasks  
- **UPDATE** existing tasks  
- **DELETE** tasks  

The application also supports **user registration**. Registered users can **log in** to their accounts. All the **task data** and **user data** is securely stored in **MongoDB**.  
<br>
